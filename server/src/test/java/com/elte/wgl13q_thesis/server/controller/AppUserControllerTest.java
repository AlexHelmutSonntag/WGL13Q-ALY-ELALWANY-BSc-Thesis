...
public class AppUserControllerTest {
    ...
    public static void authSetupWithCredentials(String username, String password) {
        ...
        env.put("refresh_token", response.jsonPath().get("refresh_token"));
    }
...
//        log.info(String.valueOf(response.getStatusCode()));
    ...
    @Test
    public void shouldUserGetAllUsersAsList()  {
        String username = "test_user";
        String password = "test_user_password";
        String firstName = "Test";
        String lastName = "User";
        ...
        Assertions.assertEquals(HTTP_OK, response.getStatusCode());
        List<LinkedHashMap<?, ?>> list = response.jsonPath().getList("");
        Assertions.assertEquals(5,list.size());
        authSetupWithCredentials(AUTH_ADMIN_USERNAME, AUTH_ADMIN_SECRET);
        removeUser(username);
    }
    @Test
    public void shouldUserGetAllUsersAsListAndCheckContent()  {
        String username = "test_user";
        String password = "test_user_password";
        String firstName = "Test";
        String lastName = "User";
        ...
        Assertions.assertEquals(HTTP_OK, response.getStatusCode());
        List<LinkedHashMap<?, ?>> list = response.jsonPath().getList("");
        Assertions.assertEquals("1",list.get(0).get("id").toString());
        authSetupWithCredentials(AUTH_ADMIN_USERNAME, AUTH_ADMIN_SECRET);
        removeUser(username);
    }
    @Test
    public void shouldFailOnUserGetAllUsersAsListAndCheckContent()  {
        Response response =
                        get("/api/v1/user/all")
                        .then()
                        .extract().response();
    ...
    @Test
    public void shouldFailOnGetUserWithUserNotFound()  {
        ...
        Response response =
                given()
                        .auth()
                        .oauth2(accessToken).
                        get("/api/v1/user/non-existing-user")
                        .then()
                        .extract().response();
    ...
    @Test
    public void shouldFailOnGetUserWithNoToken()  {
    ...
    @Test
    public void shouldFailOnGetUserWithInvalidToken()  {
        Response response =
                given()
                        .auth()
                        .oauth2("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJkaWZmZXJlbnRfdXNlcm5hbWUiLCJyb2xlcy").
                        get("/api/v1/user/testuser")
                        .then()
                        .extract().response();
        Assertions.assertEquals(HTTP_FORBIDDEN, response.getStatusCode());
    ...
    @Test
    public void shouldGetNewAccessAndRefreshTokenForUser() {
        String username = "different_username";
        String password = "different_password";
        String firstName = "different_firstname";
        String lastName = "different_lastname";
        AppUserRole appUserRole = AppUserRole.USER;
        String email = "different@email.com";
        ...
        String role = AuthUtils.getRolesFromDecodedJWT(decodedJWT)[0];
        Assertions.assertEquals("USER", role);
        removeUser(username);
    }

    @Test
    public void shouldGetNewAccessAndRefreshTokenForAdmin() {
        String username = "different_username";
        String password = "different_password";
        String firstName = "different_firstname";
        String lastName = "different_lastname";
    ...
    @Test
    public void shouldFailOnGetNewAccessAndRefreshTokenWithNoRefreshToken() {
        String username = "different_username";
        String password = "different_password";
        String firstName = "different_firstname";
        String lastName = "different_lastname";
    ...
    @Test
    public void shouldFailOnGetNewAccessAndRefreshTokenWithTokenMissingParts() {
        String username = "different_username";
        String password = "different_password";
        String firstName = "different_firstname";
        String lastName = "different_lastname";
        ...
        String refreshToken = env.get("refresh_token");
        log.info(refreshToken);
        refreshToken = refreshToken.substring(0, refreshToken.length() / 2);
        log.info(refreshToken);
        Response response =
                given()
                        .contentType(ContentType.JSON)
    ...
    @Test
    public void shouldFailOnGetNewAccessAndRefreshTokenWithNotFoundUser() {
        String invalidRefreshToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJkaWZmZXJlbnRfdXNlcm5hbWUiLCJyb2xlcyI6WyJVU0VSIl0sImlzcyI6Imh0dHBzOi8vMTkyLjE2OC4yMTg6ODA4MC9sb2dpbiIsImV4cCI6MTY3MDAzMjUxOX0.kyvizefS_1l5zbhJGlJOX-kC5AZ1UNiSEXTGqrR8PNQ[\\r][\\n]";
        Response response =
                given()
                        .contentType(ContentType.JSON)
                        .auth()
    ...
    @Test
    public void shouldFailOnGetNewAccessAndRefreshTokenWithEmptyToken() {
